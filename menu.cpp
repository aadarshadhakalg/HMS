...
void MainWindow::contact()
{
  ...
  ans1->setText("This project is brought to you by student of Kathmandu University.\n"
 ...
 // q1->setFrameStyle(QFrame::Panel | QFrame::Sunken);
  q2->setText(tr("About Developers"));
  q2->setFont(question);
 ...
 // ans2->setFixedHeight(60);
  ans2->setText("The developers of this application are\n"
                "Aadarsha Dhakal \n"
                "Ayush Paudel \n"
                "Ayush Aryal \n"
                "Sushant Adhikari.");
 ...
 // q1->setFrameStyle(QFrame::Panel | QFrame::Sunken);
  ...
  ans3->setText("You can help us by funding our work");
  ans3->setFont(ans);
  ans3->adjustSize();
